...
import static com.example.callinfo.MainActivity.formatWithOutTime;
    ...
    public void moveToViewGraphActivity(View v){
        ...
        try {
            ...
            if (type == null || (!swtIncoming.isChecked() && !swtOutgoing.isChecked() && !swtMissed.isChecked())) {
                ...
                ArrayList<GraphDataDTO> graphDataDTOS = dbHelper.selectMultiple("Date(date), count(*)", condition + " group by Date(date)");
