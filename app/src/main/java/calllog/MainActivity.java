...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateRate(){
        try {
            ...
            Double missedRate =  totalCount != 0 ? (missedCount / totalCount) * 100 : 0;
...
//                System.out.println(date);
                ...
                System.out.println("Phone Number - " + number + ", Name - " + name + ", Type - " + type + ", Date - " + date);
            }
            managedCursor.close();
        } catch (Exception ex){
            ex.printStackTrace();
