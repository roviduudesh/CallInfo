...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<GraphDataDTO> selectGraphData(String value, String condition){
        Cursor c = null;
    ...
    public ArrayList<ExportDataDTO> selectExportData(String value, String condition){
        Cursor c = null;
        ExportDataDTO exportDataDTO;
        ArrayList<ExportDataDTO> exportDataDTOList = new ArrayList<>();
        try {
            SQLiteDatabase database = this.getWritableDatabase();
            c = database.rawQuery("SELECT " + value + " FROM Calllog WHERE " + condition, null);
            c.moveToFirst();
            if(c.getCount() > 0){
                do{
                    exportDataDTO = new ExportDataDTO();
                    exportDataDTO.setCallId(c.getInt(0));
                    exportDataDTO.setNumber(c.getString(1));
                    exportDataDTO.setName(c.getString(2));
                    exportDataDTO.setCallDate(c.getString(3));
                    exportDataDTO.setType(c.getString(4));
                    exportDataDTO.setDuration(Integer.parseInt(c.getString(5)));
